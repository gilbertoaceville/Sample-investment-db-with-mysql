...
router.post("/", async (req, res) => {
    try {
        let { email, full_name, password, upline, walletID, username, phone } = req.body;
        /**
        ...
        let newUser = await UserModel.create({ email, phone, password, full_name, upline, walletID, username })
